...
export default async function CategoriesPage() {
  ...
  return (
    <div className="shell pb-16">
      <Breadcrumbs items={[{ name: "Начало", href: "/" }, { name: "Категории", href: "/categories" }]} />
      <SectionHeading
        as="h1"
      ...
      {categories.length === 0 ? (
        <EmptyState title="Каталогът все още се синхронизира" description="Моля, проверете отново скоро." />
      ) : (
