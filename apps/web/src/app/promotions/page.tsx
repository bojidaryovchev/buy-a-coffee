...
export default async function PromotionsPage({
  ...
  return (
    <div className="shell pb-16">
      <Breadcrumbs items={[{ name: "Начало", href: "/" }, { name: "Промоции", href: "/promotions" }]} />

      <header className="mb-8 max-w-prose">
        <h1 className="font-display text-3xl font-semibold text-ink-900 md:text-4xl">Актуални промоции</h1>
        <p className="mt-2 text-base text-ink-500">
          Всичко тук е с намалена цена. Промоциите се сменят с движението на наличностите, така че си
          струва да проверявате.
        </p>
      </header>
