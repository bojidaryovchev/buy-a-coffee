...
export default function ContactPage() {
  return (
    <div className="shell pb-16">
      <Breadcrumbs items={[{ name: "Начало", href: "/" }, { name: "Контакти", href: "/contact" }]} />

      <div className="grid gap-10 lg:grid-cols-2 lg:gap-16">
        <div>
          <h1 className="font-display text-3xl font-semibold text-ink-900 md:text-4xl">Свържете се с нас</h1>
          <p className="mt-3 max-w-prose text-base text-ink-500">
            Най-бързият начин да поръчате е бутонът на всяка продуктова страница — оставяте номер и ние ви
            звъним. За всичко останало изберете начина, който ви е удобен.
          </p>
        ...
        <div>
          ...
          <p className="mt-1 text-sm text-ink-500">Обикновено отговаряме в рамките на един работен ден.</p>
          <div className="mt-5">
            <ContactForm />
          </div>
        </div>
